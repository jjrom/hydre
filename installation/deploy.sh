...
cp -Rf $RESTO_HOME/.htaccess $RESTO_HOME/favicon.ico $RESTO_HOME/index.php $RESTO_HOME/themes $RESTO_HOME/js $RESTO_HOME/resto $TARGETDIR
...
cp -Rf $HYDRE_HOME/src/resto/themes/hydre $TARGETDIR/themes && echo ' ==> Copy mapshup/config.js to '$TARGETDIR'/themes/hydre/ directory'
